...
Mean Variance plot: This plot notes the overal distribution of varaince across all genes. There is a clear positive relationship between mean expression and variance. This is expected because genes with higher expression levels tend to have higher variance in RNA-seq experiments [@isserline_2025].
...
entrez-to-hgnc <- getBM(attributes = c("entrezgene_id", "hgnc_symbol"),
...
norm_cpm_annot <- merge(entrez-to-hgnc, 
                                 norm_cpm, 
                                 by.x = "entrezgene_id", 
                                 by.y = 0, 
                                 all.y = TRUE)
