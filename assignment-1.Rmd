...
```{r}
sample_metadata
save(sample_metadata, file = "A1_all_sample_annotations.RData")
```
...
```{r}
final_normalized_counts <- norm_cpm_annot_mapped_clean

# Save the final normalized counts with a slightly different name
save(final_normalized_counts, file = "A1_normalized_counts.RData")

# Save the sample annotation data with a different name
save(sample_metadata, file = "A1_truncated_sample_annotations.RData")
